...
public class SeecondYearAdapter extends FirestoreRecyclerAdapter<StudentListModel , SeecondYearAdapter.Holder> {
    FirebaseAuth auth = FirebaseAuth.getInstance();
    FirebaseFirestore firestore = FirebaseFirestore.getInstance();
    public SeecondYearAdapter(@NonNull FirestoreRecyclerOptions<StudentListModel> options) {
        super(options);
    }
